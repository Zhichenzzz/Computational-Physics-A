...
input_txt = ".\\cmake-build-debug\\generate_dot_10000.txt"
x = []
y = []
z = []
...
plt.scatter(x,z,marker="*", c='blue')
plt.xlabel("x random")
plt.ylabel("z random")

plt.title("Random number On Square_10000_xz")
plt.savefig("Random number On Square_10000_xz.png")
plt.show()